...
│
├── 📄 README.md                          # This file
├── 🔧 .github/workflows/                 # CI/CD: Build & Test on PR
│   └── ci.yml
│
├── 📁 src/
│   ├── 📁 core/                          # Reusable Data Structures & Algorithms
│   │   ├── cpp/
│   │   │   ├── lru_cache/                # Production-style LRU Cache component
│   │   │   │   ├── include/lru_cache.h
│   │   │   │   ├── src/lru_cache.cpp
│   │   │   │   └── tests/test_lru_cache.cpp
│   │   │   ├── thread_pool/              # Concurrency primitive
│   │   │   └── graph/                    # Core Graph Algorithms
│   │   └── python/
│   │       ├── data_structures/
│   │       └── utils/spark_utils.py      # Helpers for Spark simulations
│   │
│   ├── 📁 solutions/                     # LeetCode Problem Solutions
│   │   ├── cpp/
│   │   │   ├── 0146-lru-cache.cpp        # Well-documented, tested solutions
│   │   │   └── 0295-find-median-from-data-stream.cpp
│   │   ├── python/
│   │   │   ├── 0001-two-sum.py
│   │   │   └── data_engineering/         # Dedicated folder for DE problems
│   │   │       ├── 0176-second-highest-salary.py  # Pandas & SQL
...
│   │
│   └── 📁 system_design/                 # Executable Design Docs
│       ├── datacody_agent/
│       │   ├── DESIGN.md                 # Architecture Decision Record (ADR)
│       │   └── prototype/                # Mini POC if applicable
│       └── distributed_logging.md
│
├── 📁 docs/                              # Knowledge Base
│   ├── coding_interview_guide.md
│   ├── patterns/                         # Algorithmic & System Patterns
│   │   ├── sliding_window.md
...
│   │   └── pandas.md
│   └── interview_notes/
│       ├── ai_infra_questions.md
│       └── behavioral_star.md
│
├── 📁 scripts/                           # Automation & DevOps
│   ├── setup_environment.sh
│   ├── run_tests.sh
│   └── generate_stats.py                 # Auto-generates progress metrics
│
└── 📁 progress/                          # Track Growth
    ├── solved_log.csv                    # Auto-generated by script
    ├── roadmap_90_days.md
    └── mistakes_retrospective.md
```
